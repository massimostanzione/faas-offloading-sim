...
DURATION=hours(4) # FIXME ridotta! per brevità
PERIOD_STD=DURATION
PERIOD_4= DURATION/4
...
generate_trace("sinus_delay0", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=0*DELAY)
generate_trace("sinus_delay1", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=1*DELAY)
generate_trace("sinus_delay2", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=2*DELAY)
generate_trace("sinus_delay3", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=3*DELAY)
generate_trace("sinus_delay4", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=4*DELAY)
generate_trace("sinus_delay5", "sinusoid", 0, 100, PERIOD_4, 5, DURATION, delay=5*DELAY)
generate_trace("bell_delay0", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=0*DELAY)
generate_trace("bell_delay1", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=1*DELAY)
generate_trace("bell_delay2", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=2*DELAY)
generate_trace("bell_delay3", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=3*DELAY)
generate_trace("bell_delay4", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=4*DELAY)
generate_trace("bell_delay5", "bell", 0, 100, PERIOD_4, 5, DURATION, delay=5*DELAY)
...
PERIOD_4_REDUCED=DURATION_REDUCED/2
DELAY_REDUCED=PERIOD_4/4 # un quarto d'onda di sfasamento
