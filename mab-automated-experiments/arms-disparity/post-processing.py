...
from _internal.experiment import extract_strategy_params_from_config
from _internal.experiment import MABExperiment_IterableParam
from _internal.experiment import get_param_simple_name
from _internal import consts
from _internal.graphs import plot_arms_disparity
                ...
                for other_param in other_strategy_params or [1]:
                    ...
                    for other_param_iter in prange:
                        ...
                        suffix = "" if other_param_name == "" or strat == "KL-UCBsp" else (
                                    f", {get_param_simple_name(other_param_name)}=" + str(other_param_iter))
