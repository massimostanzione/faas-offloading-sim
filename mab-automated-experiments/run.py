                ...
                with open(experiment_confpath, "r") as expconf_file:
                    ...
                    if mode_simulations_expconf == consts.ExecMode.NONE.value:
                        ...
                        exp = MABExperiment(
                            ...
                            config["experiment"]["stat-print-interval"] if 'stat-print-interval' in config["experiment"] else consts.DEFAULT_STAT_PRINT_INTERVAL,
                            config["experiment"]["mab-update-interval"] if 'mab-update-interval' in config["experiment"] else consts.DEFAULT_MAB_UPDATE_INTERVAL,
                            axis_pre,
